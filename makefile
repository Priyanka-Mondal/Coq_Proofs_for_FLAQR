...
makefile.conf: 
	coq_makefile -o makefile auto.v basics.v equiv.v hoare.v hoare2.v imp.v indprop.v induction.v list.v logic.v maps.v poly.v rel.v small.v smallstep.v smallstep2.v stlc.v stlcprop.v stlcproprevise.v stlcrevise.v 'tactics - Copy.v' Tactics.v type.v typerevise.v
